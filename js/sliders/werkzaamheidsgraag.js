export async function initWerkzaamheidsgraagSlider() {
  ...
  function generateWerkzaamheidsGraagSlider(slides) {
    let sliderHTML = `
      <h2 id="Werkzaamheidsgraag" werkzaamheidsgraag class="mb-4 font-bold text-xl xl:text-4xl break-words leading-xl xl:leading-4xl">
        Werkzaamheidsgraag
      </h2>
    ...
    <div class="relative xl:hidden">
      <div class="absolute top-[50%] -translate-y-1/2 w-full flex justify-between items-center z-10 px-4">
