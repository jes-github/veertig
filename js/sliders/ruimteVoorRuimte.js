export async function initRuimteVoorRuimteSlider() {
  ...
  function generateRuimteVoorRuimteSlider(slides) {
    let sliderHTML = `
      <h2 ruimteVoorRuimte class="mb-4 font-bold text-xl lg:text-4xl break-words leading-xl lg:leading-4xl">
        Ruimte voor Ruimte
      </h2>
    ...
    sliderHTML += `
      ...
      <div class="hidden lg:flex flex-col items-center">
        <div class="flex justify-center lg:my-16 w-full ruimte-voor-ruimte-pagination"></div>
